          ...
          <Container>
            ...
            <Nav>
              ...
              {userLogin.is_supervisor || userLogin.is_commander || userLogin.is_admin ? 
                <>
                  <Nav.Item>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square dropdownIcon" viewBox="0 0 16 16">
                      ...
                      <NavDropdown title="Manage" id="basic-nav-dropdown" color='white'>
                        {userLogin.is_admin ?
                          <>
                            ...
                            <NavDropdown.Item onClick={() => navigate('/manage-all')}>Manage All Tasks</NavDropdown.Item>
                          </>
                           :
                          ''
                        }
