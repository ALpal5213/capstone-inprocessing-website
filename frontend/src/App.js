...
>>>>>>> d06c02a712a0266b293235ebaefc4695ba251de7
//Styling Imports
import './App.css';
...
function App() {
  ...
  return (
    <GlobalContext.Provider value={{ selectedTask, setSelectedTask, selectedLocation, setSelectedLocation, currentUser, setCurrentUserk, userLogin, setUserLogin }}>
      <AllRoutes />
